...
@testset "_all_function_variables" begin
    ...
    @testset "AffExpr" begin
        ...
        # test expressions
        @test InfiniteOpt._all_function_variables(aff1) == [meas, par, hold]
    ...
    @testset "QuadExpr" begin
        ...
        # test expressions
        @test InfiniteOpt._all_function_variables(quad1) == [meas, par, hold, pt, inf]
...
@testset "_all_parameter_refs" begin
    ...
    @testset "FiniteVariable" begin
        ...
        @test InfiniteOpt._all_parameter_refs(hold) == ()
    end
